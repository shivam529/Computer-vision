...
im31 = cv2.imread("empirestate_9.jpg", 0)
im32 = cv2.imread("empirestate_10.jpg", 0)
im33 = cv2.imread("empirestate_12.jpg", 0)
im34 = cv2.imread("empirestate_14.jpg", 0)
im35 = cv2.imread("empirestate_15.jpg", 0)
im36 = cv2.imread("empirestate_16.jpg", 0)
im37 = cv2.imread("empirestate_22.jpg", 0)
im38 = cv2.imread("empirestate_23.jpg", 0)
im39 = cv2.imread("empirestate_25.jpg", 0)
im40 = cv2.imread("empirestate_27.jpg", 0)
